...
class Step1IdentityPage extends StatelessWidget {
  ...
  Widget _buildPremiumHeader(bool isDark, Color textColor, Color subtitleColor) {
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        gradient: LinearGradient(
          colors: isDark ? [const Color(0xFF323232).withValues(alpha: 0.6), const Color(0xFF1A1A2E)] : [Colors.white, const Color(0xFFF8F9FF)],
        ),
        border: Border.all(color: isDark ? Colors.white.withValues(alpha: 0.06) : _brandBlue.withValues(alpha: 0.06)),
        boxShadow: [BoxShadow(color: _brandBlue.withValues(alpha: isDark ? 0.1 : 0.04), blurRadius: 20, offset: const Offset(0, 4))],
      ),
      child: Row(
        children: [
          Container(
            ...
            decoration: BoxDecoration(
              ...
              gradient: const LinearGradient(colors: [_brandBlue, Color(0xFF1F6FEB)], begin: Alignment.topLeft, end: Alignment.bottomRight),
              boxShadow: [BoxShadow(color: _brandBlue.withValues(alpha: 0.3), blurRadius: 12, offset: const Offset(0, 4))],
            ),
            child: const Center(child: FaIcon(FontAwesomeIcons.graduationCap, color: Colors.white, size: 26)),
          ),
          ...
          Expanded(
            child: Column(
              crossAxisAlignment: CrossAxisAlignment.start,
              children: [
                Text('Identity & Academic', style: GoogleFonts.plusJakartaSans(fontSize: 22, fontWeight: FontWeight.w800, color: textColor, letterSpacing: -0.5, height: 1.2)),
                const SizedBox(height: 4),
                Text('Tell us about your academic status and goals', style: GoogleFonts.inter(fontSize: 13, fontWeight: FontWeight.w400, color: subtitleColor, height: 1.3)),
              ],
            ),
          ),
        ],
  ...
  Widget _buildSection({required FaIconData icon, required String label, required bool isDark, required Widget child}) {
    return Column(
      crossAxisAlignment: CrossAxisAlignment.start,
      children: [
        Padding(
          ...
          child: Row(
            children: [
              Container(width: 28, height: 28, decoration: BoxDecoration(borderRadius: BorderRadius.circular(8), color: _brandBlue.withValues(alpha: 0.08)), child: FaIcon(icon, size: 13, color: _brandBlue)),
              const SizedBox(width: 10),
              Text(label, style: GoogleFonts.plusJakartaSans(fontSize: 14, fontWeight: FontWeight.w700, color: isDark ? Colors.white.withValues(alpha: 0.9) : _brandBlue, letterSpacing: 0.2)),
            ],
          ),
        ),
        child,
  ...
  Widget _buildDropdown<T>(BuildContext context, {required T? value, required List<T> items, required String hint, required ValueChanged<T?> onChanged, required bool isDark}) {
    return Container(
      decoration: BoxDecoration(
        borderRadius: BorderRadius.circular(16),
        color: isDark ? const Color(0xFF323232).withValues(alpha: 0.8) : Colors.white,
        border: Border.all(color: isDark ? Colors.white.withValues(alpha: 0.08) : _brandBlue.withValues(alpha: 0.08), width: 1.5),
        boxShadow: [BoxShadow(color: isDark ? Colors.black.withValues(alpha: 0.15) : _brandBlue.withValues(alpha: 0.04), blurRadius: 8, offset: const Offset(0, 2))],
      ),
      padding: const EdgeInsets.symmetric(horizontal: 16),
      child: DropdownButtonHideUnderline(
        child: DropdownButton<T>(
          value: value, isExpanded: true,
          hint: Text(hint, style: GoogleFonts.inter(fontSize: 15, color: isDark ? Colors.white.withValues(alpha: 0.3) : _brandBlue.withValues(alpha: 0.35))),
          ...
          icon: Container(padding: const EdgeInsets.all(6), decoration: BoxDecoration(borderRadius: BorderRadius.circular(8), color: _brandBlue.withValues(alpha: isDark ? 0.15 : 0.08)), child: const FaIcon(FontAwesomeIcons.chevronDown, size: 12, color: _brandBlue)),
          borderRadius: BorderRadius.circular(16),
    ...
    return GestureDetector(
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
          ...
          color: isDark ? const Color(0xFF323232).withValues(alpha: 0.8) : Colors.white,
          border: Border.all(
            color: model.startLabel != null ? _brandBlue : isDark ? Colors.white.withValues(alpha: 0.08) : _brandBlue.withValues(alpha: 0.08),
        ...
        child: Row(
          children: [
            Container(padding: const EdgeInsets.all(6), decoration: BoxDecoration(borderRadius: BorderRadius.circular(8), color: _brandBlue.withValues(alpha: isDark ? 0.15 : 0.08)), child: const FaIcon(FontAwesomeIcons.calendar, size: 14, color: _brandBlue)),
            const SizedBox(width: 12),
            Expanded(
              child: Text(
                model.startLabel ?? 'Tap to select month & year',
                style: GoogleFonts.inter(fontSize: 15, fontWeight: model.startLabel != null ? FontWeight.w600 : FontWeight.w400,
            ...
            SizedBox(
              ...
              child: model.startLabel != null
                  ? Container(
                      ...
                      decoration: BoxDecoration(color: _brandGold.withValues(alpha: 0.2), borderRadius: BorderRadius.circular(6)),
              ...
              child: SizedBox(
                ...
                child: Column(
                  children: [
                    ...
                    const SizedBox(height: 16),
                    Text('Select intake period', style: GoogleFonts.plusJakartaSans(fontSize: 18, fontWeight: FontWeight.w700, color: isDark ? Colors.white : const Color(0xFF1A1A2E))),
                    const SizedBox(height: 4),
                    Text('When do you plan to begin your studies?', style: GoogleFonts.inter(fontSize: 13, color: isDark ? Colors.white.withValues(alpha: 0.5) : const Color(0xFF1A1A2E).withValues(alpha: 0.5))),
                            ...
                            children: List.generate(12, (i) {
                              ...
                              return GestureDetector(
                                ...
                                child: AnimatedContainer(
                                  ...
                                  child: Text(_months[i], style: GoogleFonts.inter(fontSize: 13, fontWeight: isSelected ? FontWeight.w600 : FontWeight.w400, color: isSelected ? Colors.white : isDark ? Colors.white.withValues(alpha: 0.7) : const Color(0xFF1A1A2E).withValues(alpha: 0.7))),
                                ),
                              );
                            }),
                          ),
                                  ...
                                  return Padding(
                                    ...
                                    child: GestureDetector(
                                      ...
                                      child: AnimatedContainer(
                                        ...
                                        child: Text('$year', style: GoogleFonts.plusJakartaSans(fontSize: 14, fontWeight: isSelected ? FontWeight.w700 : FontWeight.w500, color: isSelected ? Colors.white : isDark ? Colors.white.withValues(alpha: 0.7) : const Color(0xFF1A1A2E).withValues(alpha: 0.7))),
                                      ),
                                    ),
                                  );
                                }),
                    ...
                    Padding(
                      ...
                      child: SizedBox(
                        ...
                        child: ElevatedButton(
                          ...
                          style: ElevatedButton.styleFrom(backgroundColor: _brandBlue, shape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(14))),
                          child: Text('Select ${_months[selectedMonth - 1]} $selectedYear', style: GoogleFonts.plusJakartaSans(fontSize: 15, fontWeight: FontWeight.w600, color: Colors.white)),
                        ),
                      ),
                    ),
                  ],
  ...
  String _validationHint(StudentOnboardingModel m) {
    if (m.educationLevel == null && m.desiredDegreeLevel == null) return 'Select your education level and desired degree';
    ...
    return Container(
      ...
      child: Row(
        children: [
          ...
          Expanded(
            child: TextField(
              controller: TextEditingController(text: model.customField ?? '')..selection = TextSelection.fromPosition(TextPosition(offset: model.customField?.length ?? 0)),
  ...
  // ── Multi-Select Chips (fixed-width checkmark to prevent layout shift) ──
  Widget _buildMultiSelectChips(BuildContext context, {required List<String> options, required List<String> selected, required ValueChanged<String> onToggle, required bool isDark}) {
    return Wrap(
      spacing: 8, runSpacing: 8,
        ...
        return GestureDetector(
          ...
          child: AnimatedContainer(
            ...
            decoration: BoxDecoration(
              ...
              border: Border.all(color: isSelected ? _brandBlue : isDark ? Colors.white.withValues(alpha: 0.08) : _brandBlue.withValues(alpha: 0.08), width: isSelected ? 2 : 1.5),
