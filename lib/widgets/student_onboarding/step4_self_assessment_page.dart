...
class Step4SelfAssessmentPage extends StatelessWidget {
    ...
    return SingleChildScrollView(
      ...
      child: Column(
        ...
        children: [
          ...
          Text(
            'Help us understand your strengths and interests.',
          ...
          // ── Strengths ──
          _sectionLabel('Strengths', isDark),
          const SizedBox(height: 4),
          Text(
            'Select subjects or skills you excel in',
            style: GoogleFonts.inter(
              fontSize: 12,
              fontWeight: FontWeight.w400,
              color: subtitleColor,
          ...
          // ── Weaknesses ──
          _sectionLabel('Weaknesses', isDark),
          const SizedBox(height: 4),
          Text(
          ...
          // ── Interests ──
          _sectionLabel('Interests', isDark),
          const SizedBox(height: 4),
          Text(
            'Select hobbies, extracurriculars, or broader interests',
            style: GoogleFonts.inter(
              fontSize: 12,
              fontWeight: FontWeight.w400,
              color: subtitleColor,
          ...
          // ── Career Goals ──
          _sectionLabel('Career Goals', isDark),
          const SizedBox(height: 4),
          Text(
            'Select the category that best matches your career aspirations',
            style: GoogleFonts.inter(
              fontSize: 12,
              fontWeight: FontWeight.w400,
              color: subtitleColor,
                  ...
                  child: ElevatedButton(
                    ...
                    child: Text(
                      ...
                      style: GoogleFonts.plusJakartaSans(
                        fontSize: 16,
                        fontWeight: FontWeight.w600,
                        color: model.step4Valid ? Colors.white : subtitleColor,
                      ),
                    ),
                  ),
                ),
  ...
  // ── Career Goal Picker (single-select chips) ──
